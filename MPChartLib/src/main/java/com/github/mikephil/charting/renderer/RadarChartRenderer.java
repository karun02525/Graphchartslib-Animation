    ...
    protected void drawDataSet(Canvas c, IRadarDataSet dataSet, int mostEntries) {
        ...
        for (int j = 0; j < dataSet.getEntryCount(); j++) {
            ...
            if (!hasMovedToPoint) {
                ...
                if(j==1)
                {
                    Shader shader = new LinearGradient(a2,b2,a0, b0, 0xff77D990,0xffFFB854, Shader.TileMode.REPEAT /*or REPEAT*/);
                    ...
                    mRenderPaint.setColor(-12233);   // right

                    a2 = pOut.x;
                    b2 = pOut.y;
                    c.drawLine(a2,b2,a0, b0,paint);
                }
                ...
                if(j==2)
                {
                    Shader shader = new LinearGradient(a0,b0,pOut.x, pOut.y, 0xff77D990, 0xff5AC8FA , Shader.TileMode.REPEAT /*or REPEAT*/);
                    ...
                    mRenderPaint.setColor(-92233); // left
                    c.drawLine(a0,b0,pOut.x, pOut.y,paint);



                    Shader shader1 = new LinearGradient(a2,b2,pOut.x, pOut.y,0xffFFB854, 0xff5AC8FA, Shader.TileMode.REPEAT /*or REPEAT*/);

                    Paint paint1 = new Paint();
                    paint1.setShader(shader1);
                    paint1.setStrokeWidth(dataSet.getLineWidth());
                    paint1.setStyle(Paint.Style.STROKE);



                    mRenderPaint.setColor(-33939); // DOWN
                    c.drawLine(a2,b2,pOut.x, pOut.y,paint1);
                }

                /*if(j==0)
                {
                    mRenderPaint.setColor(-12233);
                c.drawPath(surface,mRenderPaint);
                }
                else if(j==1)
                {
                    mRenderPaint.setColor(-65536);
                    c.drawPath(surface,mRenderPaint);
                }
                else if(j==2)
                {
           ...
           /*     if(j ==0) {
                ...
                else if(j == 1)
                {
                   ...
                   // c.drawLine(a1, a2, b1, b2, mWebPaint);
                   // c.drawLine(a1, a2, pOut.x, pOut.y, mWebPaint);
                    c.drawLine(pOut.x, pOut.y, b1, b2, mWebPaint);
                }*/
            }
        }
